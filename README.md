...
Важно: физическая папка называется `pages-layer`, а не `pages`, потому что корневой `pages/` в Next зарезервирован под legacy routes. При этом архитектурный алиас остается `@pages/*`.
